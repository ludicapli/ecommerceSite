import { debug as debug$1, headers, retry, jsonRequest, jsonResponse, progress, observable as observable$1 } from 'get-it/middleware';
...
function _listen(query, params) {
  ...
  return new Observable(observer => {
    ...
    async function getEventSource() {
      const {
        default: EventSource
      } = await import('./node-8ef1b8f8.js').then(function (n) {
        return n.node;
      });
...
//# sourceMappingURL=index-980f9149.js.map
