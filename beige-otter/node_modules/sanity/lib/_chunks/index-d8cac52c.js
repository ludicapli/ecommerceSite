...
import { usePaneLayout, usePane, PaneContent, PaneHeader, BackLink, PaneHeaderActions, Pane, _DEBUG } from './desk-4e7be0ae.js';
import { Delay, useDeskTool, useDeskToolSetting } from './index-56aa5cc3.js';
...
import { PaneItem } from './PaneItem-9d0095a8.js';
...
const addSelectedStateToMenuItems = options => {
  ...
  return menuItems == null ? void 0 : menuItems.map(item => {
    ...
    if ((_c = item == null ? void 0 : item.params) == null ? void 0 : _c.by) {
      return {
        ...item,
        selected: isEqual(sortOrderRaw == null ? void 0 : sortOrderRaw.by, ((_d = item == null ? void 0 : item.params) == null ? void 0 : _d.by) || EMPTY_ARRAY)
      };
    }
    return {
      ...item,
...
const DocumentListPane = memo(function DocumentListPane2(props) {
  ...
  const menuItemsWithSelectedState = useMemo(() => addSelectedStateToMenuItems({
    menuItems,
    sortOrderRaw,
    layout
